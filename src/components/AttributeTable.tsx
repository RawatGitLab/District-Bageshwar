...
export default function AttributeTable({
  ...
  return (
    <div className="w-[450px] border-l border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 flex flex-col h-full shrink-0 shadow-sm font-sans transition-all duration-300 text-slate-800 dark:text-slate-100">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[10px] text-indigo-600 dark:text-indigo-400 font-extrabold mt-0.5">Bageshwar Geoportal Data Analytics</p>
            </div>
          </div>
            ...
            {currentLayer && (
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full text-xs pl-9 pr-4 py-1.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-slate-800 dark:text-slate-100 placeholder-slate-400 focus:outline-indigo-500 focus:bg-white dark:focus:bg-slate-800 transition"
                />
              </div>
            )}
          </>
          ...
          <table className="w-full text-left text-xs border-collapse font-sans">
            <thead>
              <tr className="bg-slate-100/60 dark:bg-slate-800/80 sticky top-0 border-b border-slate-200 dark:border-slate-800 shadow-sm z-10 text-slate-600 dark:text-slate-300 font-bold leading-tight select-none">
                ...
                {columnKeys.map((key) => (
                  <th key={key} className="py-2.5 px-3 border-r border-slate-200 dark:border-slate-800 uppercase tracking-wider font-mono text-[10px] bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300">
                    {key}
                  </th>
                ))}
              </tr>
      ...
      {currentLayer && filteredFeatures.length > 50 && (
        <div className="px-4 py-2 bg-slate-50 dark:bg-slate-900 border-t border-b border-slate-200 dark:border-slate-800 flex items-center justify-between text-xs font-semibold select-none text-slate-600 dark:text-slate-300 shrink-0">
          ...
          <div className="flex items-center gap-1.5">
            <button
              ...
              className="px-2 py-0.5 rounded border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-700 disabled:opacity-40 disabled:hover:bg-white dark:disabled:hover:bg-slate-800 transition cursor-pointer text-[10px]"
            >
              Prev
            </button>
