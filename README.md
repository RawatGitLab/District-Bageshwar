...
This repository hosts the **Bageshwar GIS Viewer** — a web application for visualizing geographic and administrative data for Bageshwar District, Uttarakhand.
